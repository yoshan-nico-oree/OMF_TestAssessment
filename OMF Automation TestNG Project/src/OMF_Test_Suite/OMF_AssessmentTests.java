...
public class OMF_AssessmentTests  {
    
	@Test (priority=1)
	public void HomePage_Verification()
	{
		//This is where an Object for the Chrome Browser is created
		System.setProperty("webdriver.chrome.driver", "C:\\Nico Master\\Test Lab\\Selenium_WebDriver\\chromedriver_win32\\chromedriver.exe");                          
	...
	public void TermCapital_Verification()
	{
		...
		//Find the element Capital & get its text value. Show text value to to validate that the correct Capital value is rendered
		...
		
	{
		...
		//Find the element Term & get its text value. Show text value to to validate that the correct Term value is rendered
